...
const PoliceStationLocator = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center px-4 md:px-16 py-10 bg-white">
      {/* Heading Section */}
      <div className="w-[80vw] flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div className="flex-1">
          <h1 className="text-[32px] md:text-[48px] text-[#121D33] mb-2 text-center lg:text-left">
            Find Your Police Station
          </h1>
          <p className="text-base md:text-lg text-[#374151] text-center lg:text-left">
            Get information about the nearest police station and seek necessary
            help.
          </p>
        </div>

        <p className="text-[#121D33] text-sm md:text-base max-w-full lg:max-w-[30%] text-left">
        ...
        <button className="bg-[#57462a] hover:bg-[#605036] text-white px-5 py-3 rounded-lg font-semibold shadow-md w-full sm:w-auto">
      ...
      {/* Dropdowns */}
      <div className="bg-[#F5F7FA] w-[80vw] mt-10 p-6 md:p-8 rounded-xl shadow-sm flex flex-col gap-4 ">
      ...
      {/* Map Section */}
      <div className="mt-8 rounded-2xl overflow-hidden shadow-md w-[80vw] h-[400px] md:h-[600px] lg:h-[700px]">
        <iframe
